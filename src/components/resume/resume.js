              ...
              <div>
                ...
                <div className="links">
                  <div className="link-item">
                    ...
                    <a href="http://google.ca">arjunchowdary335@gmail.com</a>
                  </div>
                  <div className="link-item">
                ...
                <ul>
                    <li>Strong Knowledge of webtechnologies including <strong>- HTML5|CSS3|SASS|Bootstrap|AngularMaterialDesign|ReactMaterialDesign|Javascript/ES7|ReactJS|Angular8|Nodejs|Express|MongoDB.</strong></li>
                ...
                <div className="job">
                  <div className="job-title-container">
                    <div>
                      ...
                      <div className="job-title">Bachelors of computer applications(BCA).</div>
                    </div>
                    <div>
                      Jan 2015 - Jan 2018
            </div>
